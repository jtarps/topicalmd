...
def map_product_to_sanity(product: dict) -> dict:
    ...
    doc = {
        ...
        "size": str(product.get("size_g", "")),
        "applicationType": product.get("application_type", ""),
        "OTC": product.get("otc_rx", "OTC") == "OTC",
        "isGeneric": product.get("is_generic", False),
        "notes": product.get("notes", ""),
        "region": [r.strip() for r in product.get("available_in", "US").split(",")],
    }
